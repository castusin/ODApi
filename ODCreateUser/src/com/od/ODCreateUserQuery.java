...
public class ODCreateUserQuery {
	...
	public static String SQL_USERTABLE="insert into User_table (User_id,first_name,last_name,phoneno1,phone2,address1,address2,city,state,pin_code,Creation_date)"+"values(?,?,?,?,?,?,?,?,?,?,?)";     
