...
public class ODSaveParkInfoModel {
	...
	public List<ODParkRoomsModel> parkRooms;
	public List<ODParkFacilitiesModel> parkFacilities;
	public List<ODParkPricingModel> parkPricing;
	...
	public List<ODParkRoomsModel> getParkRooms() {
		return parkRooms;
	}

	public void setParkRooms(List<ODParkRoomsModel> parkRooms) {
		this.parkRooms = parkRooms;
	}

	public List<ODParkFacilitiesModel> getParkFacilities() {
		return parkFacilities;
	}

	public void setParkFacilities(List<ODParkFacilitiesModel> parkFacilities) {
		this.parkFacilities = parkFacilities;
	}

	public List<ODParkPricingModel> getParkPricing() {
		return parkPricing;
	}

	public void setParkPricing(List<ODParkPricingModel> parkPricing) {
		this.parkPricing = parkPricing;
	}
