...
public class EmailCommunication {
	...
	public CISResults sendPaymentstatus(String paymentEmail, String firstName, String roomType, Date checkIn, Date checkOut, int qty, float price, int transactionId) {
		CISResults cisResult = new CISResults();
		//String emailId=CISConstants.ADMINEMAILID;
		...
		String msg="<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
				...
				"<p><b>Room Category :</b>"+roomType+" <br />"+
				...
				"<p><b>Note:</b> Please do not reply to this email. It has been sent from an email account that is not monitored. To ensure that you receive communication related to your booking from MakeMyTrip.com, please add connect@outingday.com to your contact list and address book. </b><br /></b><br />"+
	...
	public CISResults sendAdminSuccessMail(String firstName, String roomType, Date checkIn, Date checkOut,
			int qty, float price, int transactionId) {
		CISResults cisResult = new CISResults();
		String emailId=CISConstants.ADMINEMAILID;
	...
	public CISResults sendSupplierSuccessMail(String supplierEmail,
			String firstName, String roomType, Date checkIn, Date checkOut,
			int qty, float price, int transactionId) {
		CISResults cisResult = new CISResults();
		//String emailId=CISConstants.ADMINEMAILID;
