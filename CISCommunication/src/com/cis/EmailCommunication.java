...
public class EmailCommunication {
	...
	public CISResults sendPaymentstatusCOD(String paymentEmail,
			String firstName, Date checkIn, Date checkOut, float price,
			String transactionId, String title, float totalPrice, int qty,
		...
		String msg="<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
				...
				"<p>Facility quantity "+qty+"</b><br />"+
				"<p>Facility Type "+title+"</b><br />"+
	...
	public CISResults sendAdminSuccessMailCOD(String firstName, Date checkIn,
			Date checkOut, float price, String transactionId, String title,
			float totalPrice, int qty, String streetAddress, String city,
	...
	public CISResults sendPaymentstatus(String paymentEmail, String firstName,
			Date checkIn, Date checkOut, float price, String transactionId,
			String title, float totalPrice, int qty, String streetAddress,
			String city, String state, int pin, String parkName,
			String suppCell, String suppEmail) {
