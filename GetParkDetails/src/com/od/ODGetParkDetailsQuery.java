...
public class ODGetParkDetailsQuery {
	...
	public static String SQL_GETPARKSDETAILS = "SELECT Name,OD_Rating,Metro,Local_area,Street_address,City,State,PIN,Overview_text, Faq,Main_photo_url FROM Park_info   WHERE Park_id =? "; 
