...
public class ODGetParkDetailsQuery {
	...
	public static String SQL_GETPARKSDETAILSLIST = "SELECT Room_type_code,Room_type_desc,Max_adults,Max_kids,Max_qty,Current_available_qty,Regular_price FROM  Park_rooms_inventory WHERE Park_id =? ";    
